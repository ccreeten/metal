...
public class SelectorTest {
    ...
    private static final Token ITEM = seq(VALUE, VALUE);
    private static final Token NAMED_ITEM = seq("item", VALUE, VALUE);
    ...
    public void testGetValues() throws IOException {
        ...
        assertThat(firstValue.slice.offset, is(equalTo(0L)));
